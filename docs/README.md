...
la url en la que se despliega es: [https://arquisoft.github.io/dede_es6c/](https://arquisoft.github.io/dede_es6c/).
...
Si queremos desplegar la documentación en GitHub pages, estará accesible en [https://arquisoft.github.io/dede_es6c/](https://arquisoft.github.io/dede_es6c/) necesitamos ejecutar `npm run deploy`.
