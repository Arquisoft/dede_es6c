...
El flujo de trabajo se encuentra en el archivo [asw2122.yml](https://github.com/Arquisoft/dede_es6c/tree/master/.github/workflows).  Si lo revisas podrás ver que existen dos trabajos, uno para la restapi(**unit-test-restapi**) y otro para la webapp(**unit-test-webapp**). Estos trabajos se ejecutan de forma paralela por lo que aceleran la construcción de las imagenes. 
